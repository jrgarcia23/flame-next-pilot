...
export default function HomeRestyleTemplate({ cfg, enHref, currentLang = "es" }: { cfg: HomeRestyleConfig; enHref: string; currentLang?: "es" | "en" }) {
  ...
  return (
    <>
      ...
      <section className="py-[60px] relative overflow-hidden" style={{ background: "var(--color-navy)", color: "white" }}>
      ...
      <section className="py-[60px]" style={{ background: "var(--color-paper)" }}>
        <div className="flame-container">
      ...
      {cfg.ctaStripBold && (
        <section className="py-[60px]" style={{ background: "var(--color-navy)" }}>
          <div className="flame-container">
      ...
      <section className="py-[60px] overflow-hidden" style={{ background: "var(--color-paper)" }}>
        <div className="flame-container">
