    ...
    <>
        ...
        <div className="flame-container">
          <div className="text-center mb-14 mx-auto" style={{ maxWidth: 760 }}>
            <h2 className="text-[clamp(32px,3.4vw,48px)] font-normal" style={{ color: "var(--color-navy)", letterSpacing: "-0.02em", lineHeight: 1.08, fontFamily: "var(--font-display)" }}>
              <span style={{ color: "var(--color-accent)", fontWeight: 500 }}>{cfg.benefitsTitleHl}</span> {cfg.benefitsTitle}
            </h2>
      ...
      <section className="py-24" style={{ background: "#fff" }}>
        <div className="flame-container">
          <div className="mb-14 max-w-[720px]">
            <h2 className="text-[clamp(32px,3.4vw,48px)] font-normal" style={{ color: "var(--color-navy)", letterSpacing: "-0.02em", lineHeight: 1.08, fontFamily: "var(--font-display)" }}>
              {cfg.metricsTitle} <span style={{ color: "var(--color-accent)", fontWeight: 500 }}>{cfg.metricsTitleHl}</span>
            </h2>
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: "var(--color-navy)", color: "white" }}>
        ...
        <style>{`
          ...
          .industry-card { width: 320px; flex: 0 0 320px; transition: transform 420ms cubic-bezier(0.22, 1, 0.36, 1), background 420ms cubic-bezier(0.22, 1, 0.36, 1), border-color 420ms cubic-bezier(0.22, 1, 0.36, 1), box-shadow 420ms cubic-bezier(0.22, 1, 0.36, 1); }
      ...
      {/* CASOS DE ÉXITO relacionados (relativos al caso de uso) — fondo blanco: navy → blanco → paper */}
      {cfg.caseStudies && cfg.caseStudies.length > 0 && (
        <section className="py-24" style={{ background: "#fff" }}>
          <div className="flame-container">
            <div className="text-center mx-auto" style={{ maxWidth: 660, marginBottom: 44 }}>
              <span className="uc-cases-eyebrow">{currentLang === "en" ? "Case studies" : "Casos de éxito"}</span>
          ...
          <style>{`
            .uc-cases-eyebrow { display:inline-block; font-family: var(--font-body); font-size:12.5px; font-weight:600; letter-spacing:0.14em; text-transform:uppercase; color: var(--color-accent-deep); margin-bottom:14px; }
            .uc-case-card { transition: transform 420ms cubic-bezier(0.22,1,0.36,1), box-shadow 420ms cubic-bezier(0.22,1,0.36,1), border-color 420ms cubic-bezier(0.22,1,0.36,1); }
            .uc-case-card:hover { transform: translateY(-2px); box-shadow: 0 18px 40px -22px rgb(15 23 42 / 0.35); border-color: var(--color-rule-strong); }
            @media (max-width: 900px){ .uc-cases-grid { grid-template-columns: 1fr !important; max-width: 420px; margin: 0 auto; } }
          `}</style>
        </section>
      )}
