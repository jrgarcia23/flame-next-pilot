...
/**
 * AnimatedQueueAnalyticsChart — dashboard People Counting con N elementos
...
export default function AnimatedQueueAnalyticsChart() {
  ...
  return (
    <div
      ref={setRefs}
      className="aqa-wrap rounded-2xl overflow-hidden relative"
      style={{
        background: "#fff",
    ...
    >
      ...
      <style>{`
        @media (prefers-reduced-motion: reduce) {
          .aqa-wrap > div[aria-hidden] { transition: none !important; }
        }
      `}</style>
    </div>
  );
