...
const DEFAULT_ELEMENTS: ElementCfg[] = [
  ...
  { id: "overlay-mq6m75r1",  kind: "overlay", label: "Overlay 2",
    left: 57.08, top: 65.49, right: 1.08,  bottom: 9.25,  delay: 0,  animation: "wipe-up" },
  { id: "overlay-mq6m7rbv",  kind: "overlay", label: "Overlay 3",
    left: 17.07, top: 23.73, right: 73.65, bottom: 66.26, delay: 0,  animation: "wipe-right" },
  { id: "overlay-mq6m83l2",  kind: "overlay", label: "Overlay 4",
    left: 40.85, top: 23.95, right: 49.89, bottom: 65.94, delay: 0,  animation: "wipe-right" },
  { id: "overlay-mq6m8gq8",  kind: "overlay", label: "Overlay 5",
    left: 64.63, top: 23.34, right: 25.83, bottom: 65.91, delay: 0, animation: "wipe-right" },
  { id: "overlay-mq6m8qkt",  kind: "overlay", label: "Overlay 6",
    left: 88.84, top: 23.59, right: 2.08,  bottom: 66.19, delay: 0, animation: "wipe-right" },
  { id: "overlay-mq6m8zil",  kind: "overlay", label: "Overlay 7",
    left: 88.54, top: 43.53, right: 2.23,  bottom: 46.47, delay: 0, animation: "wipe-right" },
  { id: "overlay-mq6m9ag3",  kind: "overlay", label: "Overlay 8",
    left: 9.04,  top: 85.47, right: 54.27, bottom: 0,     delay: 0, animation: "wipe-right" },
  ...
  { id: "counter-mq6meod2", kind: "counter", label: "Contador 14 (61.76)",
    ...
    delay: 0, value: 61.76, decimals: 2, thousandsSep: "", prefix: "", suffix: "",
    fontSize: 16, fontWeight: 600, color: "#15163A", align: "left", duration: 1600 },

  // Overlay extra del gráfico que faltaba (JR, sesión posterior)
  { id: "overlay-mq6ox5ei", kind: "overlay", label: "Overlay 15",
    left: 64.52, top: 43.60, right: 25.33, bottom: 46.12, delay: 0, animation: "wipe-right" },
];
