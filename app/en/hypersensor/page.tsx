...
export default function HypersensorEn() {
  ...
  return (
    <>
      ...
      {/* 1. HERO — clones live: h1 (brand + eyebrow) + sub + CTA + image */}
      <section
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{ background: "linear-gradient(180deg, rgb(21 22 58 / 0.75) 0%, rgb(21 22 58 / 1) 75%)" }} />
        <div className="flame-container relative z-10">
          <div className="text-center mx-auto" style={{ maxWidth: 980 }}>
            <h1 className="mb-7" style={{ fontFamily: "var(--font-display)", letterSpacing: "-0.024em", lineHeight: 1.04 }}>
              <span className="block font-normal" style={{ color: "#fff", fontSize: "clamp(56px,7.6vw,108px)" }}>Hypersensor</span>
      ...
      {/* 1.5 BENEFITS — 4 cards below hero */}
