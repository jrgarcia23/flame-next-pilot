...
const cfg: UseCaseConfig = {
  ...
  bigSectionPara1: "Retailers and brands investing in retail media no longer accept estimates. They want to know exactly how many people stood in front of each screen, in which time slot, with what demographic profile, and how many of them later visited the advertised store.",
  bigSectionPara2: "Flame turns your existing camera network into an audited measurement layer for your DOOH inventory. No extra hardware, no facial recognition, all data aggregated and anonymous under GDPR — plus native integration with the main signage CMS and DOOH platforms in your stack. With that data, the venue stops working with estimated impressions and starts selling verified audience.",
  ...
  benefits: [
    ...
    { icon: "integration", title: "Connect to DOOH and your CMS",                desc: "Flame works as an analytics layer independent of the hardware and the CMS. The traffic and behaviour data it generates can complement any DOOH stack, and we can integrate with the systems already in use." },
  ...
  metrics: [
    ...
    { icon: "reports",      title: "Campaign reports",            desc: "Report ready to send to the brand and the agency after every campaign, with the key results per screen and zone." },
  ],
