...
const cfg: UseCaseConfig = {
  ...
  benefits: [
    { icon: "grid", title: "Simplifica la gestión de accesos", desc: "Gestiona fácilmente las conexiones de empleados y visitantes con credenciales temporales y control automatizado desde una plataforma central." },
    { icon: "privacy", title: "Mejora la seguridad y el cumplimiento", desc: "Asegúrate de que solo los usuarios autorizados se conecten a tu red, manteniendo la privacidad, la trazabilidad y la seguridad de nivel empresarial." },
    { icon: "integration", title: "Integración sin complicaciones", desc: "Utiliza APIs para automatizar la provisión e integrar la gestión de acceso WiFi en tus sistemas de TI o de visitantes existentes." },
    { icon: "users", title: "Mejora la experiencia del visitante", desc: "Permite que los visitantes soliciten acceso directamente mediante un formulario o la aprobación del anfitrión: rápido, sencillo y totalmente personalizado con la identidad de tu empresa." },
  ],
