...
const cfg: UseCaseConfig = {
  ...
  benefits: [
    { icon: "wifi", title: "Captura de datos", desc: "Recopila perfiles de clientes completos y basados en el consentimiento a través del acceso WiFi y crea tu propia base de datos de audiencia cumpliendo con el RGPD." },
    { icon: "trending", title: "Interactúa en el momento adecuado", desc: "Activa campañas automáticas basadas en la ubicación cuando los clientes se conectan, visitan o regresan, aumentando la conversión y la relevancia." },
    { icon: "users", title: "Personaliza experiencias", desc: "Utiliza datos demográficos y de comportamiento para adaptar mensajes, ofertas y contenidos a cada segmento de audiencia." },
    { icon: "integration", title: "Integración con tu ecosistema", desc: "Conéctate con CRM, PMS o herramientas de automatización de marketing para sincronizar perfiles, automatizar flujos de trabajo y medir el impacto real." },
  ],
