...
const cfg: UseCaseConfig = {
  ...
  benefits: [
    { icon: "journey", title: "Descubre el recorrido completo de conversión", desc: "Observa cómo evolucionan los clientes potenciales — de transeúntes a visitantes y compradores — y comprende el rendimiento en cada etapa." },
    { icon: "eye", title: "Mejora la captación y la retención", desc: "Descubre qué escaparates, campañas u horas punta atraen más visitantes y les animan a quedarse más tiempo." },
    { icon: "dwell", title: "Aprovecha los datos de duración de visita", desc: "Analiza cómo el tiempo de permanencia se correlaciona con las ventas y el engagement para ajustar la distribución, el servicio y las promociones." },
    { icon: "trending", title: "Impulsa la conversión y la rentabilidad", desc: "Conecta datos de tráfico y comportamiento con las ventas del TPV para descubrir qué impulsa realmente las decisiones de compra y el ROI." },
  ],
