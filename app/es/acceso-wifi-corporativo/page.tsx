...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/es/acceso-wifi-corporativo/",
    languages: {
  ...
  openGraph: {
    type: "website",
    url: "https://www.flameanalytics.com/es/acceso-wifi-corporativo/",
    ...
    <UseCaseTemplate
      ...
      bigSectionVisualOverride={
        <AnimatedDashboardImage
          src="/wp-content/uploads/2026/01/Corporate_Wifi_Access_recorte.png"
          alt="Flame dashboard"
