...
export const metadata: Metadata = {
  ...
  description: "Analítica de flujos de pasajeros, aforo y colas para aeropuertos, estaciones e intercambiadores con IA de vídeo, sin biometría y conforme al RGPD. Anticipa aglomeraciones y planifica el personal.",
  alternates: {
