...
const cfg: UseCaseConfig = {
  ...
  benefits: [
    { icon: "eye", title: "Monitorea las colas en tiempo real", desc: "Controla de manera continua la longitud de las colas, los tiempos de espera y el flujo para garantizar un servicio fluido durante las horas punta." },
    { icon: "alert", title: "Evita abandonos", desc: "Identifica esperas prolongadas con anticipación, activa alertas o acciones automáticamente y reduce los abandonos de clientes antes de que ocurran." },
    { icon: "users", title: "Optimiza el servicio y el personal", desc: "Utiliza los datos de las colas para ajustar dinámicamente los niveles de personal y mejorar la eficiencia y capacidad de respuesta en general." },
    { icon: "integration", title: "Automatiza e integra", desc: "Conecta Flame a sistemas externos mediante API para activar acciones, desde notificaciones al personal hasta señalización digital o actualizaciones en el CRM." },
  ],
