...
const cfg: UseCaseConfig = {
  ...
  benefits: [
    { icon: "eye", title: "Monitorea el uso en tiempo real", desc: "Registra el número de visitas por aseo para saber exactamente cuándo se requiere limpieza o mantenimiento." },
    { icon: "alert", title: "Alertas de limpieza automatizadas", desc: "Envía notificaciones al personal automáticamente al superar cada umbral de uso, asegurando una higiene óptima sin desperdiciar recursos." },
    { icon: "connect", title: "App móvil inteligente para el personal", desc: "Empodera a los equipos de limpieza con una app para confirmar intervenciones, reiniciar contadores y mantener visibilidad del estado en tiempo real." },
    { icon: "reports", title: "Trazabilidad y generación de informes completa", desc: "Mantén un registro completo de las acciones de limpieza y del uso de los aseos para garantizar cumplimiento, responsabilidad y calidad del servicio." },
  ],
