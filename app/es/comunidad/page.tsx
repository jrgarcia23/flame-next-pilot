...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Comunidad · Flame Analytics",
    description: "Entrevistas, casos reales, webinars y descargas.",
...
export default function ComunidadHubEs() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flame-container relative z-10">
          <div style={{ maxWidth: 720 }}>
            <p className="mb-4 font-medium" style={{ color: "var(--color-accent)", fontSize: 13, letterSpacing: ".18em", textTransform: "uppercase", fontWeight: 700 }}>Comunidad Flame</p>
            <h1 className="text-[clamp(46px,5.8vw,76px)] font-normal mb-6" style={{ color: "#fff", letterSpacing: "-.028em", lineHeight: 1.02, fontFamily: "var(--font-display)" }}>
              Bienvenido a nuestra <span style={{ color: "var(--color-accent)", fontWeight: 500 }}>comunidad</span>
            </h1>
      ...
      {/* ANCLAS sticky en formato .cta-btn--md */}
      ...
      {/* ENTREVISTAS */}
      {ent.length > 0 && <Section sid="entrevistas" bg="paper" eyebrow="Entrevistas" h2a="Conversaciones con quienes" h2b="deciden" link={`Ver las ${countEnt}`} href="/es/categoria/entrevistas/" items={ent} />}
      ...
      {/* DESCARGABLES */}
      {wp.length > 0 && (
        <section className="sec sec--paper" id="descargables" style={{ background: "var(--color-paper)", padding: "clamp(72px,8vw,128px) 0", scrollMarginTop: 88 }}>
          <div className="flame-container">
            <div className="sec-head" style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 32, flexWrap: "wrap", marginBottom: 56 }}>
              <div>
                <p style={{ fontSize: 12, letterSpacing: ".16em", textTransform: "uppercase", fontWeight: 700, marginBottom: 14, color: "var(--color-accent-deep)" }}>Descargables</p>
                <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(34px,3.8vw,52px)", fontWeight: 400, letterSpacing: "-.024em", lineHeight: 1.04, maxWidth: "20ch" }}>
                  Whitepapers e <span style={{ color: "var(--color-accent-deep)", fontWeight: 500 }}>informes técnicos</span>
                </h2>
              </div>
            </div>
            <div className="wp-grid">
              {wp.map(w => {
                ...
                return (
                  <a key={w.slug} href={`/es/whitepaper/${w.slug}/`} className="wp-card">
      ...
      {/* DEMO FORM — mismo patrón que sobre-nosotros */}
      ...
      {/* Estilos del hub — anclas + cards listado + XL + whitepapers */}
      <style>{`
      ...
      {/* Highlight ancla activa */}
      <script dangerouslySetInnerHTML={{ __html: `
        (function(){
          const links = document.querySelectorAll('.anchor-link');
          const ids = ['entrevistas','casos','blog','webinars','descargables'];
    ...
    <section className={`sec ${bgCls}`} id={sid}>
      <div className="flame-container">
        ...
        <div className="mag-row">
          <a href={`/es/${xl.slug}/`} className="mag-xl" style={{ backgroundImage: xlImg ? `url('${xlImg}')` : undefined, backgroundColor: play ? "#0E0F26" : undefined }}>
        ...
        <div className="cat-grid">
          {minis.map((m, i) => {
            ...
            return (
              <a key={m.slug} href={`/es/${m.slug}/`} className="cat-card">
