...
const WHY_FLAME = [
  { icon: "eye",      title: "Precisión real del 99 %",  desc: "Medición fiable en cualquier espacio físico: cambios de luz, picos de afluencia o paso múltiple no afectan al dato." },
