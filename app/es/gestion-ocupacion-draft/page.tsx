...
const cfg: UseCaseConfig = {
  ...
  benefits: [
    { icon: "eye", title: "Visibilidad de la ocupación en tiempo real", desc: "Monitoriza los niveles de ocupación en directo en recintos, plantas o zonas para mantener el confort, la eficiencia y la seguridad." },
    { icon: "trending", title: "Anticipa la demanda y realiza ajustes", desc: "Predice los picos y adapta dinámicamente el personal, la limpieza o las políticas de acceso para mejorar las operaciones." },
    { icon: "users", title: "Mejora la experiencia del visitante", desc: "Evita la masificación y asegura un flujo óptimo que hace cada visita más fluida y agradable." },
    { icon: "grid", title: "Optimiza el uso del espacio", desc: "Analiza patrones de uso para equilibrar recursos, reducir la capacidad ociosa y tomar decisiones espaciales más inteligentes." },
  ],
