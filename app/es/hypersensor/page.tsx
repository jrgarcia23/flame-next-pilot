...
export const metadata: Metadata = {
  title: HS_ES.meta.title,
  description: HS_ES.meta.description,
  alternates: {
    canonical: "/es/hypersensor/",
    languages: {
      es: "/es/hypersensor/",
      en: "/en/hypersensor/",
...
const enHref = "/en/hypersensor/";

export default function HypersensorEs() {
  ...
  return (
    <>
      ...
      {/* 1. HERO — clavado al live: texto izda contenido + imagen Group-281 absoluta hasta borde derecho del viewport */}
      <section
      ...
      >
        ...
        />
        {/* Gráfico SVG animado: 4 nodos input → HyperSensor central → FLAME dashboard (flujo dotted dinámico) */}
        ...
        <div className="flame-container">
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 820 }}>
            <h2 className="text-[clamp(32px,3.4vw,48px)] font-normal mb-6" style={{ color: "var(--color-navy)", letterSpacing: "-0.02em", lineHeight: 1.08, fontFamily: "var(--font-display)" }}>
              ¿Por qué <span style={{ color: "var(--color-accent)", fontWeight: 500 }}>Flame</span>?
            </h2>
            <p className="text-[clamp(17px,1.25vw,19px)] leading-relaxed mx-auto" style={{ color: "var(--color-ink-2)", maxWidth: "64ch" }}>
              La plataforma de análisis avanzado para espacios físicos que combina el vídeo con la IA para mejorar la toma de decisiones y el rendimiento general del local.
            </p>
          </div>
        </div>
      ...
      {/* 5. PRODUCTOS — 2 cols (izquierda título/sub/bullets, derecha 3 cards) — clon de HomeRestyle */}
      <section className="py-[80px]" style={{ background: "var(--color-paper)" }}>
        <div className="flame-container">
          <div
      ...
      {/* 6. FAQ — mismo patrón que UseCaseTemplate */}
      <section className="py-[80px]" style={{ background: "var(--color-paper)" }}>
        <div className="flame-container">
          <h2
      ...
      <section className="py-[80px]" id="contact" style={{ background: "#fff" }}>
        <div className="flame-container">
          ...
          >
            ...
            <DemoFormInline lang={"es"} variant="demo" gridClass="hs-form-grid" />
          </div>
        </div>
        <style>{`
