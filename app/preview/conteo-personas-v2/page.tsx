...
/**
 * DRAFT — versión de /es/conteo-personas/ con cascada de 5 overlays
 * sobre el dashboard People-Counting_recorte.png. Las 5 zonas de
 * gráficos se descorren en cascada de izq → der al hacer scroll.
 *
 * URL: /preview/conteo-personas-v2/
 *
 * noindex+nofollow, no está en sitemap. Solo para review de JR.
 */

export const metadata: Metadata = {
  title: "[DRAFT] Conteo de personas · animaciones · Flame Analytics",
  description: "Preview interno — cascada de overlays sobre el dashboard People Counting.",
...
export default function ConteoPersonasDraftV2() {
  return (
    <UseCaseTemplate
      cfg={cfg}
