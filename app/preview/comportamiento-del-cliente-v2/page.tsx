...
/**
 * DRAFT — versión de /es/comportamiento-del-cliente/ con dashboard animado
 * inspirado en el estilo Refero/Ventriloc en lugar de la imagen estática.
 *
 * URL: /preview/comportamiento-del-cliente-v2/
 *
 * Esta página NO está en sitemap.xml y lleva noindex/nofollow.
 * Es solo para review interno de JR. Una vez aprobado, se aplica el
 * cambio en la página live /es/comportamiento-del-cliente/.
 */

export const metadata: Metadata = {
  title: "[DRAFT] Comportamiento del cliente · animaciones · Flame Analytics",
  description: "Preview interno — dashboard animado inspirado en estilo Refero.",
  robots: { index: false, follow: false },
};

// Mismo cfg que la página live (copia 1:1 para que la comparación sea limpia)
const cfg: UseCaseConfig = {
  metaTitle: "Comportamiento del cliente · Flame Analytics",
  ...
  bigSectionTitle: "Más que movimientos:",
  bigSectionTitleHl: "comportamiento accionable",
  ...
  benefits: [
    { icon: "behavior", title: "Diseña espacios que vendan",         desc: "Utiliza insights de movimiento para crear distribuciones que guíen al cliente de forma natural." },
    { icon: "occupancy", title: "Detecta zonas frías",                desc: "Identifica áreas infrautilizadas y reorganiza el espacio para sacar todo su potencial." },
    { icon: "eye",      title: "Aumenta el engagement",               desc: "Mide qué productos y zonas atraen más atención y ajusta el merchandising." },
    { icon: "trending", title: "Mejora la conversión",                desc: "Optimiza el flujo desde la entrada hasta la caja para reducir abandonos." },
  ],
...
export default function CustomerBehaviorDraftV2() {
  return (
    <UseCaseTemplate
      cfg={cfg}
