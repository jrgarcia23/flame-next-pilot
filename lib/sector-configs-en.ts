...
const CASES: Record<string, { href: string; img: string; title: string; excerpt: string; date: string }> = {
  multiopticas: { href: "https://www.flameanalytics.com/es/multiopticas-convierte-el-trafico-en-tienda-en-decisiones-de-negocio/", img: "https://uryoqblopkijfqnzquhm.supabase.co/storage/v1/object/public/blog-media/case-studies/2026/07/multiopticas-es-v3-6a5e012d.jpg", title: "How MultiÓpticas turns in-store traffic into business decisions", excerpt: "MultiÓpticas launches an advanced in-store analytics project with Flame Analytics to turn physical data into network intelligence.", date: "20 July 2026" },
