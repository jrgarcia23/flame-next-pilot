...
export const RETAIL_CFG_EN: SectorConfig = {
  ...
  capabilities: [
    ...
    { span: 7, featured: true, img: "/wp-content/uploads/2026/01/Industries_Retail-1.png", svg: IC.bars, title: "Compare and optimise your stores", desc: "Measure each store's KPIs (outdoor and indoor traffic, capture, conversion…) and compare them. Identify best and worst practices by location and replicate what works across your network." },
...
export const SUPERMERCADOS_CFG_EN: SectorConfig = {
  ...
  capabilities: [
    ...
    { span: 5, svg: IC.activity, title: "Real-time occupancy and capacity", desc: "Track how many people are present at any moment and by zone, with alerts when a section or the checkout line saturates. Act before crowding turns into a bad experience." },
...
export const HOTELES_CFG_EN: SectorConfig = {
  ...
  heroSub: "Flame turns the cameras and WiFi you already have in your hotel into actionable data: footfall and occupancy of the lobby, the restaurant or the spa. Hotel analytics with artificial intelligence, no biometrics and fully GDPR-compliant, to adjust staff, control capacity and justify every installation with real data.",
  heroBullets: HERO_BULLETS,
  sections: [],
  ...
  painPoints: [
    ...
    { svg: IC.alert, title: "You don't know real-time occupancy", desc: "At events, dining rooms and common areas you need to know how many people are present at each moment. Without reliable counting, you can't control capacity or guarantee safety." },
  ...
  capabilities: [
    { span: 7, featured: true, img: "/wp-content/uploads/2026/01/Industries_Hospitality-1.png", svg: IC.building, title: "Optimise occupancy and staffing", desc: "Measure footfall in the lobby, the restaurant, the spa or the event rooms by time slot. Match staff to real occupancy, cut unnecessary shifts and avoid waits caused by understaffing." },
...
export const ESPACIOS_CFG_EN: SectorConfig = {
  metaTitle: "Public venues · Flame Analytics", metaDescription: "Capacity, safety and flows in public venues.",
  ...
  painPointsIntro: "Running a public venue means balancing safety, visitor experience and budget, often without data. Without knowing capacity or people flows, decisions on staff, openings and events end up based on intuition.",
  painPoints: [
    { svg: IC.alert, title: "You don't know the real occupancy of each space", desc: "Without reliable data on how many people are in each hall or entrance, capacity control depends on manual counts. By the time you spot saturation, the safety risk is already there." },
  ...
  capsSub: "Eight capabilities to run your public venue with real data: from capacity control to justification before the authorities. All without biometrics and fully GDPR-compliant.",
  capabilities: [
    { span: 7, featured: true, img: "/wp-content/uploads/2026/01/Industries_Public_venues-scaled-1.png", svg: IC.shield, title: "Capacity and safety in real time", desc: "Check total and per-zone occupancy and get alerts before reaching the limit. Analyse pedestrian flows to anticipate crowds and safely plan events, openings and high-footfall moments." },
  ...
  casesSub: "Cultural centres and large networks that use Flame to control capacity, analyse flows and know the real use of each space.",
  caseStudies: pickCases(["caixaforum", "repsol", "multiopticas"]),
  productsTitle: PRODUCTS_TITLE, productsTitleHl: PRODUCTS_TITLE_HL, productsSub: PRODUCTS_SUB, productsBullets: PRODUCTS_BULLETS, products: PRODUCTS,
...
export const BANCOS_CFG_EN: SectorConfig = {
  ...
  capabilities: [
    ...
    { span: 5, svg: IC.activity, title: "Real-time occupancy and capacity", desc: "Check how many people are in each zone of the office and control the capacity of the waiting and personal-service areas. Anticipate saturation before it hurts the customer experience." },
    ...
    { span: 6, svg: IC.clock, title: "Real-time queue management", desc: "Monitor queue length at the counter, customer service and advisers, and get alerts when the wait exceeds the set limit. React before the experience deteriorates or the customer leaves the office." },
    { span: 6, svg: IC.wifi, title: "Capture and communication via WiFi", desc: "Offer WiFi to customers through a captive portal and provide secure corporate networks for employees. Turn the connection into a channel to inform about products and services while the customer waits or is being served at the office." },
  ],
...
export const TRANSPORTE_CFG_EN: SectorConfig = {
  ...
  painPoints: [
    ...
    { svg: IC.shield, title: "Anticipating operational risks", desc: "In a high-footfall, high-sensitivity space, not knowing each zone's occupancy is a risk. Without real-time data, you act when saturation is already obvious." },
  ],
  ...
  capabilities: [
    { span: 7, featured: true, img: "/wp-content/uploads/2026/01/Industries_Public_venues-scaled-1.png", svg: IC.shield, title: "Pedestrian flows, crowd management and safety", desc: "Analyse the occupancy and flows of each zone to anticipate crowds before they form. Plan access, staff and reinforcements during footfall peaks and improve safety in real time, without biometrics and GDPR-compliant." },
    { span: 5, svg: IC.people, title: "Passenger footfall and flow", desc: "Measure entries and exits and analyse traffic by terminal, entrance and platform. Discover how many passengers move through each point and at what times to plan operations with real data." },
    ...
    { span: 6, svg: IC.heatmap, title: "Behaviour and heatmaps", desc: "Visualise how passengers move and identify the points that slow transit. Measure travel times between key zones to improve signage and optimise circulation flows." },
    { span: 5, svg: IC.bars, title: "Use of zones and services", desc: "Analyse the traffic of VIP lounges, shops, restaurants and car parks. Identify which spaces perform best and which are underused to optimise the offer and make decisions on the venue's operation." },
    { span: 7, featured: true, img: "/sectors/centros-afluencia.jpg", svg: IC.clock, title: "Queue management and restroom cleaning", desc: "Measure waits at security, check-in, ticket offices and boarding to open new positions before queues grow. Also plan restroom cleaning by real use, not fixed schedules." },
    { span: 6, svg: IC.wifi, title: "Capture and communication via WiFi", desc: "Offer connectivity through a captive portal and turn every access into a communication channel. Inform about incidents, delays and venue services while you gather aggregated data on network use." },
...
export const CENTROS_CFG_EN: SectorConfig = {
  ...
  heroBgImage: "/wp-content/uploads/2026/01/Industries_Malls2-scaled-1.png", heroBgPosition: "center center",
  ...
  capabilities: [
    ...
    { span: 7, featured: true, img: "/wp-content/uploads/2026/01/Industries_Malls2-scaled-1.png", svg: IC.building, title: "Rents and tenant mix", desc: "Traffic data by unit and zone to value each space by its real performance, justify rents and decide the tenant mix with criteria. Mall analytics as a revenue lever." },
