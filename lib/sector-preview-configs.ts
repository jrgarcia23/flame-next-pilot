...
export const ESPACIOS_CFG: SectorConfig = {
  ...
  useCasesSub: "Ocupación, seguridad, colas, aseos, comportamiento o WiFi: sea cual sea la prioridad de tu espacio público, Flame ya tiene un caso de uso para resolverla.",
  useCases: [
...
export const TRANSPORTE_CFG: SectorConfig = {
  ...
  useCasesSub: "Flujos de pasajeros, ocupación, colas, aseos, comportamiento o WiFi: sea cual sea la prioridad de tu terminal, Flame ya tiene un caso de uso para resolverla.",
  useCases: [
