...
export const RETAIL_CFG: SectorConfig = {
  ...
  caseStudies: pickCases(["multiopticas", "afflelou"]),
  ...
  useCasesSub: "Conteo, tracking de clientes, interacción entre zonas, conversión, ocupación, colas, aseos o WiFi: sea cual sea la prioridad de tu tienda, Flame ya tiene un caso de uso para resolverla.",
  useCases: [
    uc("conteo", "Mide con precisión cuánta gente entra y cómo se reparte por franjas y por zonas de la tienda."),
    { ...uc("comportamiento", "Trayectorias, permanencia y zonas frías y calientes para mejorar el layout y la señalética, y medir el impacto de escaparates, promociones y campañas."), title: "Tracking de clientes" },
    { ...uc("recorrido", "Descubre cómo se relacionan las visitas entre las secciones y zonas de la tienda para optimizar el recorrido y la colocación de producto."), title: "Interacción entre zonas de la tienda" },
    uc("conversion", "Cruza el tráfico con tu TPV para saber qué porcentaje de visitas acaba comprando en cada tienda."),
    uc("ocupacion", "Controla la ocupación en tiempo real y recibe alertas cuando la tienda o una zona se satura."),
    uc("colas", "Mide la espera en caja y abre nuevos puestos antes de que el cliente abandone la compra."),
    uc("aseos", "Programa la limpieza de los aseos según su uso real, no por un horario fijo, en tiendas de gran superficie."),
    uc("wifiInv", "Convierte el WiFi de tienda en captación de contactos y campañas de fidelización segmentadas, conectadas con tu CRM."),
  ],
};
...
export const SUPERMERCADOS_CFG: SectorConfig = {
  ...
  capabilities: [
    ...
    { span: 5, svg: IC.activity, title: "Ocupación en tiempo real", desc: "Controla cuánta gente hay en cada momento y por zona, con alertas cuando una sección o la línea de cajas se satura. Actúa antes de que la aglomeración se convierta en una mala experiencia." },
  ...
  useCasesSub: "Conteo, tracking de clientes, recorrido, interacción entre secciones, conversión, ocupación, colas, aseos o WiFi: sea cual sea la prioridad de tu supermercado, Flame ya tiene un caso de uso para resolverla.",
  useCases: [
    uc("conteo", "Mide la afluencia por secciones y franjas para conocer el tráfico real de cada zona del súper."),
    { ...uc("comportamiento", "Mapas de calor y permanencia por pasillo para mejorar el layout, las cabeceras y la reposición, y medir el impacto de tus promociones."), title: "Tracking de clientes" },
    uc("recorrido", "Reconstruye el recorrido del cliente por el súper, de la entrada a la caja, para optimizar la circulación."),
    { ...uc("recorrido", "Descubre cómo se relacionan las visitas entre secciones (fresco, droguería, cajas) para ordenar el surtido y las promociones."), title: "Interacción entre secciones" },
    uc("conversion", "Cruza el tráfico con tu TPV para saber qué porcentaje compra y cuál es la cesta media real."),
    uc("ocupacion", "Controla la ocupación en tiempo real y recibe alertas cuando una zona o la línea de cajas se satura."),
    uc("colas", "Mide la espera en caja y abre puestos antes de que el cliente abandone la compra."),
    uc("aseos", "Programa la limpieza de los aseos según su uso real, no por un horario fijo, en superficies grandes."),
    uc("wifiInv", "Convierte el WiFi del súper en captación de contactos y promociones segmentadas, conectadas con tu CRM."),
  ],
};
...
export const HOTELES_CFG: SectorConfig = {
  ...
  painPoints: [
    ...
    { svg: IC.alert, title: "Desconoces la ocupación en tiempo real", desc: "En eventos, comedores y zonas comunes necesitas saber cuántas personas hay en cada momento. Sin un conteo fiable, no puedes controlar la ocupación ni garantizar la seguridad." },
...
export const ESPACIOS_CFG: SectorConfig = {
  metaTitle: "Espacios públicos · Flame Analytics", metaDescription: "Ocupación, seguridad y flujos en espacios públicos.",
  ...
  painPointsIntro: "Gestionar un espacio público exige equilibrar seguridad, experiencia del visitante y presupuesto, muchas veces sin datos. Sin conocer la ocupación ni los flujos de personas, las decisiones sobre personal, aperturas y eventos terminan basándose en la intuición.",
  painPoints: [
    { svg: IC.alert, title: "Desconoces la ocupación real de cada espacio", desc: "Sin datos fiables sobre cuántas personas hay en cada sala o acceso, el control de la ocupación depende de conteos manuales. Cuando detectas la saturación, el riesgo para la seguridad ya existe." },
  ...
  capsSub: "Ocho capacidades para gestionar tu espacio público con datos reales: desde el control de la ocupación hasta la justificación ante la administración. Todo sin biometría y con pleno cumplimiento del RGPD.",
  capabilities: [
    { span: 7, featured: true, img: "/wp-content/uploads/2026/01/Industries_Public_venues-1.jpg", svg: IC.shield, title: "Ocupación y seguridad en tiempo real", desc: "Consulta la ocupación total y por zona y recibe alertas antes de alcanzar el límite. Analiza los flujos peatonales para anticipar aglomeraciones y planificar con seguridad eventos, aperturas y momentos de gran afluencia." },
  ...
  casesSub: "Centros culturales y grandes redes que utilizan Flame para controlar la ocupación, analizar los flujos y conocer el uso real de cada espacio.",
  caseStudies: pickCases(["caixaforum", "repsol", "multiopticas"]),
  productsTitle: PRODUCTS_TITLE, productsTitleHl: PRODUCTS_TITLE_HL, productsSub: PRODUCTS_SUB, productsBullets: PRODUCTS_BULLETS, products: PRODUCTS,
  testimonialsIdx: [0, 6, 2], faqs: getFaqs("public-venues", "es"),
  ctaStripBold: "Ocupación, seguridad y flujos, en tiempo real.", ctaStripLight: "Demo personalizada en 20 minutos.",  useCasesTitle: "Un caso de uso para cada reto de tu espacio",
  useCasesSub: "Conteo, tracking de visitantes, interacción entre espacios, ocupación, colas, aseos o WiFi: sea cual sea la prioridad de tu espacio público, Flame ya tiene un caso de uso para resolverla.",
  useCases: [
    uc("conteo", "Mide cuántas personas visitan el espacio, por accesos y zonas, y cuándo se producen las horas punta."),
    { ...uc("comportamiento", "Analiza recorridos y mapas de calor para detectar cuellos de botella y zonas infrautilizadas."), title: "Tracking de visitantes" },
    { ...uc("recorrido", "Descubre cómo se relacionan las visitas entre las distintas zonas y salas del espacio para organizar la programación y los flujos."), title: "Interacción entre espacios" },
    uc("ocupacion", "Controla la ocupación total y por zona en tiempo real, con alertas para anticipar aglomeraciones."),
...
export const BANCOS_CFG: SectorConfig = {
  ...
  capabilities: [
    ...
    { span: 7, svg: IC.wifi, title: "WiFi para clientes y red corporativa segura", desc: "Ofrece WiFi a los clientes mediante un portal cautivo y facilita redes corporativas seguras para los empleados. Convierte la conexión en un canal para informar sobre productos y servicios mientras el cliente espera o recibe atención en la oficina." },
    { span: 5, svg: IC.activity, title: "Ocupación en tiempo real", desc: "Consulta cuántas personas hay en cada zona de la oficina y controla la ocupación de las áreas de espera y atención personal. Anticípate a la saturación antes de que perjudique la experiencia del cliente." },
    ...
    { span: 5, svg: IC.clock, title: "Gestión de colas en tiempo real", desc: "Supervisa la longitud de las colas en caja, atención al cliente y gestor, y recibe alertas cuando la espera supera el límite establecido. Reacciona antes de que la experiencia se deteriore o el cliente abandone la oficina." },
  ],
  ...
  useCasesSub: "Conteo, tracking de clientes, interacción entre zonas, ocupación, colas o WiFi (clientes y corporativo): sea cual sea la prioridad de tu sucursal, Flame ya tiene un caso de uso para resolverla.",
  useCases: [
    uc("conteo", "Mide la afluencia de cada sucursal por franjas para planificar la operativa con datos reales."),
    { ...uc("comportamiento", "Mapas de calor de las zonas de espera, autoservicio y atención para mejorar la distribución de la oficina."), title: "Tracking de clientes" },
    { ...uc("recorrido", "Descubre qué zonas usa cada visitante (caja, autoservicio, atención personalizada) para dimensionar cada área según su demanda."), title: "Interacción entre zonas de la oficina" },
    uc("ocupacion", "Consulta la ocupación de las zonas de espera y atención en tiempo real y anticípate a la saturación."),
    uc("colas", "Controla la espera en caja, atención personal y gestor, con alertas cuando supera el límite."),
    uc("wifiInv", "Ofrece WiFi a los clientes con portal cautivo y conéctalo con tu CRM para comunicar servicios y campañas."),
    uc("wifiCorp", "Redes WiFi corporativas seguras para los empleados y los sistemas de la oficina, separadas de la red de clientes."),
  ],
};

// ==================== TRANSPORTE Y AEROPUERTOS ====================
export const TRANSPORTE_CFG: SectorConfig = {
  metaTitle: "Transporte y aeropuertos · Flame Analytics", metaDescription: "Flujos de pasajeros, ocupación y colas en aeropuertos y estaciones.",
  ...
  painPoints: [
    ...
    { svg: IC.wifi, title: "El pasajero espera sin conectividad", desc: "Los viajeros pasan largas esperas en la terminal y quieren estar conectados. Sin un WiFi fácil y fiable, su experiencia se resiente y pierdes un canal directo para informarles de incidencias, retrasos y servicios." },
  ],
  ...
  capabilities: [
    ...
    { span: 6, svg: IC.activity, title: "Ocupación en tiempo real", desc: "Consulta la ocupación de salas de espera, vestíbulos y andenes y recibe alertas cuando una zona se aproxima a su límite. Actúa antes de que la saturación afecte a la seguridad o a la experiencia del pasajero." },
    { span: 5, svg: IC.heatmap, title: "Comportamiento y mapas de calor", desc: "Visualiza cómo se desplazan los pasajeros e identifica los puntos que ralentizan el tránsito. Mide los tiempos de recorrido entre zonas clave para mejorar la señalética y optimizar los flujos de circulación." },
    { span: 7, featured: true, img: "/wp-content/uploads/2026/01/Industries_Public_venues-1.jpg", svg: IC.clock, title: "Gestión de colas y limpieza de aseos", desc: "Mide las esperas en controles de seguridad, facturación, taquillas y embarque para abrir nuevas posiciones antes de que aumenten las colas. Planifica también la limpieza de los aseos según su uso real, no mediante horarios fijos." },
    { span: 6, svg: IC.bars, title: "Uso de zonas y servicios", desc: "Analiza el tráfico de salas VIP, comercios, restaurantes y aparcamientos. Identifica qué espacios funcionan mejor y cuáles están infrautilizados para optimizar la oferta y tomar decisiones sobre la explotación del recinto." },
  ...
  useCasesSub: "Conteo, tracking de pasajeros, recorrido, interacción entre zonas, ocupación, colas, aseos o WiFi (pasajeros y corporativo): sea cual sea la prioridad de tu terminal, Flame ya tiene un caso de uso para resolverla.",
  useCases: [
    uc("conteo", "Mide el tráfico de pasajeros por terminales, accesos y andenes, y en qué horarios se concentra."),
    { ...uc("comportamiento", "Analiza recorridos y tiempos entre zonas para mejorar la señalética y la circulación."), title: "Tracking de pasajeros" },
    uc("recorrido", "Reconstruye el recorrido del pasajero por la terminal, del acceso al embarque, para reducir fricciones."),
    { ...uc("recorrido", "Descubre cómo se relacionan los flujos entre zonas de espera, comercios y restauración de la terminal."), title: "Interacción entre zonas y comercios" },
    uc("ocupacion", "Controla la ocupación de salas de espera, vestíbulos y andenes en tiempo real, con alertas."),
    ...
    uc("wifiCorp", "Redes WiFi corporativas seguras para el personal y los sistemas de la terminal, separadas de la red de pasajeros."),
  ],
};
