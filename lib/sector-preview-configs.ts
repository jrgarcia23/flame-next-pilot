...
export const BANCOS_CFG: SectorConfig = {
  ...
  heroSub: "Flame convierte las cámaras que ya tienes en tus oficinas en datos accionables: afluencia, colas y uso real de cada sucursal. Analítica para banca de oficina con inteligencia artificial, sin biometría y con pleno cumplimiento del RGPD, para dimensionar cajeros y gestores, reducir las esperas y gestionar tu red con datos reales.",
  heroBullets: HERO_BULLETS,
  sections: [],
...
export const TRANSPORTE_CFG: SectorConfig = {
  ...
  heroSub: "Flame convierte las cámaras que ya tienes en tu terminal en datos accionables: flujo de pasajeros, aforo, colas y uso de cada zona. Analítica para aeropuertos y estaciones con inteligencia artificial, sin biometría y con pleno cumplimiento del RGPD, para anticipar aglomeraciones, planificar el personal y explotar el recinto comercial con datos reales.",
  heroBullets: HERO_BULLETS,
  sections: [],
